...
function App() {
  ...
  return (
    <>
      <div>
      <h1 style={{color:'black',fontWeight:'bold',fontSize:'60px',marginTop:'35px'}} className="title-center">TODO LIST</h1>
        <section className="section-center">
          <form className="todo-form" onSubmit={handleSubmit}>
            ...
            <div  className="form-control">
              ...
              <button style={{color:'green'}} type="submit" className="submit-btn">
                {isEditing ? "Save" : "Add"}{" "}
          ...
          {list.length > 0 && (
            <div className="todo-container">
              ...
              <button style={{backgroundColor:'red'}} className="clear-btn" onClick={clearList}>
                Remove All
              </button>
            </div>
          )}
